...
class OrderLookupTest extends Component {
  state = {
    toggle: false,
    order_number: "",
    weight: 0,
  ...
  componentDidMount() {} //end componentDidMount
...
export default withRouter(connect(mapStateToProps)(OrderLookupTest));
