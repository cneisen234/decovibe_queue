        ...
        //   let billing_email = this.props.orderlist.billing_address.email;
          ...
          let shipping_email =
            ...
            if (shipping_state === "Alabama" || shipping_state === "alabama") {
              ...
              shipping_state = "AR";
            } else if (shipping_state === "California" || shipping_state === "California") {
              shipping_state = "CA";
            } else if (shipping_state === "Colorado" || shipping_state === "colorado") {
              shipping_state = "CO";
            } else if (shipping_state === "Connecticut" || shipping_state === "connecticut") {
              shipping_state = "CT";
            } else if (shipping_state === "Delaware" || shipping_state === "delaware") {
              shipping_state = "DE";
            } else if (shipping_state === "District of Columbia" || shipping_state === "district of columbia") {
              shipping_state = "D.C.";
              ...
              shipping_state = "MD";
            } else if (shipping_state === "Massachusetts" || shipping_state === "massachusetts") {
              shipping_state = "MA";
            } else if (shipping_state === "Michigan" || shipping_state === "michigan") {
              shipping_state = "MI";
            } else if (shipping_state === "Minnesota" || shipping_state === "minnesota") {
              shipping_state = "MN";
            } else if (shipping_state === "Mississippi" || shipping_state === "mississippi") {
              shipping_state = "MS";
              ...
              shipping_state = "NV";
            } else if (shipping_state === "New Hampshire" || shipping_state === "new hampshire") {
              shipping_state = "NH";
            } else if (shipping_state === "New Jersey" || shipping_state === "new jersey") {
              shipping_state = "NJ";
            } else if (shipping_state === "New Mexico" || shipping_state === "new mexico") {
              shipping_state = "NM";
            } else if (shipping_state === "New York" || shipping_state === "new york") {
              shipping_state = "NY";
            } else if (shipping_state === "North Carolina" || shipping_state === "north carolina") {
              shipping_state = "NC";
            } else if (shipping_state === "North Dakota" || shipping_state === "north dakota") {
              shipping_state = "ND";
              ...
              shipping_state = "OR";
            } else if (shipping_state === "Pennsylvania" || shipping_state === "pennsylvania") {
              shipping_state = "PA";
            } else if (shipping_state === "Rhode Island" || shipping_state === "rhode island") {
              shipping_state = "RI";
            } else if (shipping_state === "South Carolina" || shipping_state === "south carolina") {
              shipping_state = "SC";
            } else if (shipping_state === "South Dakota" || shipping_state === "south dakota") {
              shipping_state = "SD";
              ...
              shipping_state = "VA";
            } else if (shipping_state === "Washington" || shipping_state === "washington") {
              shipping_state = "WA";
            } else if (shipping_state === "West Virginia" || shipping_state === "west virginia") {
              shipping_state = "WV";
                    ...
                    <>
                      ...
                      >
                        <form onSubmit={this.orderLookup}>
                          ...
                          <center>
                            <p>
                              Select your ship from warehouse NOTE: Warehouse
                              use only
                            </p>
                            <Form.Control
                              style={{ width: "300px" }}
                        ...
                        >
                          ...
                          <tr>
                            ...
                            >
                              <b>Street:</b> <i>{shipping_street_2}</i>
                            </td>
                          </tr>
                          <tr>
                            <td
